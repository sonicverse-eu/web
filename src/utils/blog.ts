...
export function getBlogTagSummaries(posts: BlogPost[]) {
...
export function getAdjacentBlogPosts(posts: BlogPost[], currentId: string) {
...
export function getRelatedBlogPosts(posts: BlogPost[], currentPost: BlogPost, limit = 3) {
